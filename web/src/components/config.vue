      ...
      return {
        ...
        FieldSetData:{
          ...
          handleForm:[  //模态框展示的表单和提交所需的数据
            ...
            {label:"可增改",prop:"Isedit",type:"select",Downtable:"ISFlag",showDownField:"Flag",defaultValue:"True",value:""},
            {label:"输入类型",prop:"Edittype",type:"select",Downtable:"InputTypeTable",showDownField:"Title",defaultValue:"输入框",value:""},
            ...
            {label:"是否排序",prop:"Sortable",type:"select",Downtable:"ISFlag",showDownField:"Flag",defaultValue:"False",value:""},
            {label:"是否显示列头",prop:"Visible",type:"select",Downtable:"ISFlag",showDownField:"Flag",defaultValue:"True",value:""},
            {label:"字段注释",prop:"comment",type:"input",value:""},
            {label:"字段类型",prop:"type",type:"select",Downtable:"FieldType",showDownField:"Type",defaultValue:"VARCHAR",value:""},
            {label:"VARCHAR长度",prop:"length",type:"input",value:""},
            {label:"是否为主键",prop:"primarykey",type:"select",Downtable:"ISFlag",showDownField:"Flag",defaultValue:"False",value:""},
            {label:"是否自增",prop:"autoincrement",type:"select",Downtable:"ISFlag",showDownField:"Flag",defaultValue:"False",value:""},
            {label:"是否为空",prop:"nullable",type:"select",Downtable:"ISFlag",showDownField:"Flag",defaultValue:"True",value:""},
          ],
          tableSelection:true, //是否在第一列添加复选框
