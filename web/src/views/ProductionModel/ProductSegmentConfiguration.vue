  ...
  <el-row>
    <el-col :span="24">
      <div class="page-title">
        <span style="margin-left: 10px;" class="text-size-normol">产品段任务配置</span>
      </div>
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        PermissionTableData:{
          tableName:"ProductControlTask",
          column:[
            {label:"ID",prop:"ID",type:"input",value:"",disabled:true,showField:false,searchProp:false},
            {prop:"PDCtrlTaskCode",label:"产品段编码",type:"input",value:""},
            {prop:"PDCtrlTaskName",label:"产品段名称",type:"input",value:""},
