    ...
    <el-row :gutter='20'>
        ...
        <el-col :span='17'>
            ...
            <el-row class="mgt24">
                ...
                <el-col class="mgt24" style="textAlign:right;" v-if="IsDoing"><el-button type="primary" @click="postResult">审核结果</el-button></el-col>
            </el-row>
        </el-col>
    </el-row>
</template>
...
export default {
    data(){
        return {
           currentstep:6,
           IsDoing:JSON.parse(sessionStorage.getItem('Rights').replace(/'/g, '"')).includes("质检审核"),
