                              ...
                              <el-col :span='20'>
                                  ...
                                  <el-col :span='24' class="mgt24">
                                       <el-row :gutter='10'>
                                          ...
                                          <el-col :span='5'>
                                            <el-select v-model="distribute.Group1" placeholder="请选择"><el-option v-for="item in Groupsarr" :key="item.value" :label="item.label" :value="item.value"></el-option>
                                            </el-select>
                                          </el-col>
                                      </el-row>
                                  </el-col>
                              ...
                              <el-col :span='20'>
                                  ...
                                  <el-col :span='24' class="mgt24">
                                        <el-row :gutter='10'>
                                          ...
                                          <el-col :span='5'>
                                            <el-select v-model="distribute.Group2" placeholder="请选择"><el-option v-for="item in Groupsarr" :key="item.value" :label="item.label" :value="item.value"></el-option>
                                            </el-select>
                                          </el-col>
                                      </el-row>
                                  </el-col>
                              ...
                              <el-col :span='20'>
                                  ...
                                  <el-col :span='24' class="mgt24">
                                       <el-row :gutter='10'>
                                          ...
                                          <el-col :span='5'>
                                            <el-select v-model="distribute.Group3" placeholder="请选择"><el-option v-for="item in Groupsarr" :key="item.value" :label="item.label" :value="item.value"></el-option>
                                            </el-select>
                                          </el-col>
                                      </el-row>
                                  </el-col>
