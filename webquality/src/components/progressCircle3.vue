<template>
    <div class="container is-current" style="backgroundColor:#eee;">
        ...
        <div style="overflow:hidden;">
            <div class="box" style="height:160px;backgroundColor:#ccc;" id="box7"></div>
            <div class="txtp">
...
export default {
    ...
    mounted(){
     ...
     beforeDestroy(){
            this.myecharts3.clear()
            this.myecharts3.dispose()
            this.myecharts3=null
      },
    methods: {
         drawpic(comment,startvalue,stopvalue) {
               this.myecharts3=echarts.init(document.getElementById('box7'))
               var option = {
                    title: [{
                        text:comment,
                        x: 'center',
